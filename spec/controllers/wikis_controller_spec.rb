  ...
  context "signed-in user" do
    ...
    describe "POST create" do
      it "increases the number of wiki by 1" do
        expect{ post :create, params: { wiki: { title: create_wiki.title, body: create_wiki.body }}}.to change(Wiki,:count).by(1)
      end

      it "assigns the new wiki to @wiki" do
        post :create, params: { wiki: { title: create_wiki.title, body: create_wiki.body }}
